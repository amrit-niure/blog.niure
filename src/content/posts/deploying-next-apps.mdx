...
$username = "root";    // This is your name
$password = "root";    // This is your secret knock
...
To get in, you need a name (`$username`), a password (`$password`), and the name of the place inside, like your toy box (`$dbname = "mydatabase"`).  
